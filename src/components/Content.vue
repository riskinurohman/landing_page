      ...
      <div class="row mt-4">
        ...
        <div class="col-lg-12">
          <div class="ratio ratio-21x9">
            <iframe src="https://www.youtube.com/embed/ofme2o29ngU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
        </div>
      </div>
      <!-- End Quotes -->
